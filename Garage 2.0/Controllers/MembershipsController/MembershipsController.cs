...
namespace Garage_2._0.Controllers.MembershipsController
{
    public class MembershipsController : Controller
    {
        private readonly GarageVehicleContext _context;

        public MembershipsController(GarageVehicleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(string id, Membership membership)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!MembershipExists(membership.Type))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Membership.Any(e => e.Type == id);
        }
    }
}
